// InkceptionIcon — single vector standard for the whole UI.
// Per blueprint §2: 24×24 viewBox, stroke-current, round caps/joins.
...
const ICONS = {
  ...
  eyeOff: (
    <>
      <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-10-8-10-8a13.45 13.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 10 8 10 8a13.16 13.16 0 0 1-1.67 2.68" />
      <path d="M1 1l22 22" />
    </>
  ),
  lock: (
  ...
  ai: (
    <>
      ...
      <path d="M12 12h.01" strokeWidth="2.6" strokeLinecap="round" />
    </>
  ),
  ...
  focus: (
    <>
      <circle cx="12" cy="12" r="3" />
      <path d="M12 2v3m0 14v3M2 12h3m14 0h3M5.64 5.64l2.12 2.12m8.48 8.48 2.12 2.12M18.36 5.64l-2.12 2.12M7.76 16.24l-2.12 2.12" />
    </>
  ),
  flipH: <path d="M4 12h16M9 7l-5 5 5 5M15 7l5 5-5 5" />,
  flipV: <path d="M12 4v16M7 9l5-5 5 5M7 15l5 5 5-5" />,
  ...
  brush: <path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" />,
  upload: (
    <>
      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
  ...
  more: (
    <path d="M12 5.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM12 13.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM12 21.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
  ),
  info: (
    <>
      <circle cx="12" cy="12" r="9" />
